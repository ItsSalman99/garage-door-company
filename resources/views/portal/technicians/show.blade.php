...
@section('content')
    <div class="cover-all-content">
        <div class="page-title d-flex align-items-center justify-content-between gap-3 flex-wrap">
            <h2>{{ $user->full_name }} <small class=" opacity-06 font-weight-400 font-24px">({{ $user->id }})</small></h2>
                            ...
                            <div class="row g-4">
                                <div class=" col-lg-4">
                                    <div class="pb-3 border-bottom">
                                        <h6 class=" font-weight-400 font-16px mb-2">Name: </h6>
                                        <h5 class=" font-weight-600 font-18px m-0 text-truncate">{{ $user->ful_name }}</h5>
                                    </div>
                                </div>
                                <div class=" col-lg-4">
                                    <div class="pb-3 border-bottom">
                                        <h6 class=" font-weight-400 font-16px mb-2">Email: </h6>
                                        <h5 class=" font-weight-600 font-18px m-0"
                                            style="overflow-x: auto; overflow-y:hidden">{{ $user->email }}</h5>
                                    </div>
                                </div>
                                <div class=" col-lg-4">
                                    <div class="pb-3 border-bottom">
                                        <h6 class=" font-weight-400 font-16px mb-2">Phone: </h6>
                                        <h5 class=" font-weight-600 font-18px m-0">{{ $user->phone }}</h5>
                                    </div>
                                </div>
                                <div class=" col-lg-4">
                                    <div class="pb-3 border-bottom">
                                        <h6 class=" font-weight-400 font-16px mb-2">Gender: </h6>
                                        <h5 class=" font-weight-600 font-18px m-0"> {{ $user->gender }}</h5>
                                    </div>
                                </div>
                                <div class=" col-lg-4">
                                    <div class="pb-3 border-bottom">
                                        <h6 class=" font-weight-400 font-16px mb-2">Date Of Birth: </h6>
                                        <h5 class=" font-weight-600 font-18px m-0"> {{ $user->dob }} </h5>
                                    </div>
                                </div>
                                <div class=" col-lg-4">
                                    <div class="pb-3 border-bottom">
                                        <h6 class=" font-weight-400 font-16px mb-2">Status: </h6>
                                        <h5 class=" font-weight-600 font-18px m-0"> {{ ($user->status == 1) ? 'Active' : 'In Active' }} </h5>
                                    </div>
                                </div>
                            </div>
                        </div>
