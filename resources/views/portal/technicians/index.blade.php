        ...
        <div class=" position-relative">
            <div class="DTable-top-elements justify-content-center justify-content-lg-end">
                <div class="d-flex  flex-wrap flex-lg-nowrap gap-2">
                    <a href="#" data-bs-toggle="modal" data-bs-target="#addModal" class="btn btn-primary gap-2"><i class="bi bi-person-plus-fill"></i> Add Technicians</a>
                </div>
            </div>
                    ...
                    <tbody>
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class=" font-weight-600 font-18px text-primary">{{ ($user->status) ? 'Active' : 'In Active' }}</td>
